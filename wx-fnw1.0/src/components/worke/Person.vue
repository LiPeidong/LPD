<template>
  <div class="Person">
    ...
    <div class="Person_header">
      <div class="Person_headerimg">
        ...
        <div class="Person_headerimgtext">
          ...
          <p>工号：{{id}}</p>
          <p>星级：
            <van-icon name="star" color="#ffa800" size="14px"/> 4.8
          </p>
        </div>
      </div>
    </div>
    ...
    <router-link :to="{path : '/Thisserve/',query:{card_id:card_id}}">
    ...
    <div class="Person_li" style>
      <ul>
        ...
        <li>
          <router-link :to="{path:'/Anomaly',query:{worker_id:worker_id}}">
...
export default {
  ...
  created() {
    ...
    var workId = "";
    if ((workId = this.$route.query.worker_id)) {
...
<style scoped>
  .Person_margin{margin-bottom: 14px;}
  .Person_active{padding-bottom: 30px !important;}
